...
Confirmed by an actual in-game error dialog the author hit on load: `SKSE/Trampoline.h(287):
...
but was not what needed fixing. See 1.0.3 below for the real cause, found only after the author
